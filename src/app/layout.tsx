...
export const metadata: Metadata = {
  ...
  description:
    "অ্যাডভোকেট মোল্লা মোঃ আলী আশ্রাফ (এম.এস.এস, এলএল.বি, ঢাকা বিশ্ববিদ্যালয়) — ২৫ বছরের অভিজ্ঞতাসম্পন্ন দেওয়ানি আইনজীবী। সম্পত্তি, ভূমি, উত্তরাধিকার, রিয়েল এস্টেট ও দেওয়ানি মামলা সংক্রান্ত আইনগত পরামর্শ ও আদালতে প্রতিনিধিত্ব।",
  keywords: [
    "দেওয়ানি আইনজীবী",
    "সম্পত্তি আইনজীবী",
  ...
  openGraph: {
    ...
    description:
      "২৫ বছরের অভিজ্ঞতাসম্পন্ন দেওয়ানি আইনজীবী (এম.এস.এস, এলএল.বি, ঢা: বি:)। সম্পত্তি, ভূমি, উত্তরাধিকার ও দেওয়ানি বিষয়ে আইনগত সহায়তা।",
    type: "website",
    locale: "bn_BD",
  },
  robots: {
